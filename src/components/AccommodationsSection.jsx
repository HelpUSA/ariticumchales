...
import { Users, Tv, Flame, Wind, Coffee, Waves, Eye, MessageCircle, X, ChevronLeft, ChevronRight, Check } from 'lucide-react';
...
const CHALES_DATA = [
  {
    ...
    subtitle: 'Ideal para casais em busca de romance e tranquilidade na serra',
    ...
    description: 'Chalé aconchegante totalmente equipado para casais. Possui cama king size confortável, cozinha gourmet privativa com cooktop, micro-ondas e geladeira/frigobar, TV de 50 polegadas, ar-condicionado split e varanda aconchegante com rede.',
    features: [
      'Cama King Size',
  ...
  },
  {
    ...
    description: 'Espaço funcional e extremamente acolhedor. Equipado com 1 cama de casal e 1 cama solteiro (ou sofás sob medida), cozinha gourmet privativa pronta para refeições práticas, TV 50", ar-condicionado split e ambiente super ventilado.',
    features: [
  ...
  },
  {
    ...
    subtitle: 'Espaçoso e completo para famílias e grupos de até 4 pessoas',
    ...
    description: 'Nosso maior chalé, perfeito para quem busca conforto e liberdade em grupo. Possui espaço amplo, cozinha gourmet totalmente equipada, mesas para refeição, TV 50", ar-condicionado split e varanda espaçosa.',
    features: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredChales.map((chale) => (
            <div
              key={chale.id}
              className="bg-white rounded-3xl overflow-hidden shadow-lg border border-gray-100 flex flex-col transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl group"
            >
              ...
              <div className="relative h-64 overflow-hidden">
                ...
                {/* Capacity Tag */}
                <div className="absolute top-4 left-4 bg-[#0A3526]/85 backdrop-blur text-white text-xs font-semibold px-3 py-1.5 rounded-full flex items-center space-x-1.5 shadow">
                ...
                >
                  ...
                  <span>Ver Fotos ({chale.gallery.length})</span>
                </button>
              </div>
              ...
              <div className="p-6 flex-1 flex flex-col justify-between">
                <div>
                  <h3 className="font-serif font-bold text-2xl text-[#0A3526] mb-1">
                    {chale.title}
                  </h3>
